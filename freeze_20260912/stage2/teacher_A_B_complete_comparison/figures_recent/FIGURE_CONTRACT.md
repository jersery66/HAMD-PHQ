...
Final size: 7.2 × 5.6 inches
Panel map:
  a: PHQ/HAMD separate A/B/C selection by mean total-score MAE
...
Image-integrity notes: no raw clinical images; all plotted marks are source-table values; SVG text remains editable
